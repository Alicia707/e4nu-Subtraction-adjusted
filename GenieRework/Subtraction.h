...
struct Subtraction {
  ...
  void  prot1_pi3_rot_funcNew(TVector3  V3prot, TVector3 V3pi[3], TLorentzVector V4prot, TLorentzVector V4pi[3], int q_pi[3], TLorentzVector V4_el, double Ecal[3], double p_miss_perp[3], double P_tot[3], int targetCharge, double P_test[10], double Ecal_test[10], double P_1p3pi_to_1p2pi[4], double E_cal[4]);
  void  prot1_pi3_rot_funx(TVector3  V3prot, TVector3 V3pi[3], TLorentzVector V4prot, TLorentzVector V4pi[3], int q_pi[3], TLorentzVector V4_el, double Ecal[3], double p_miss_perp[3], double P_tot[3], int targetCharge,  double P_tot_1p3pi_1p2pi[12], double Ecal_1p3pi_1p2pi[12], double P_tot_1p3pi_1p1pi[6], double Ecal_1p3pi_1p1pi[6]);
