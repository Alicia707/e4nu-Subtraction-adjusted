...
class event_selector { 
   ...
   std::string ffile_name; // The data file name // 
   ...
   event_selector(std::string, std::string, std::string, TTree *tree = 0);
...
#ifdef event_selector_cxx

event_selector::event_selector(std::string a_ftarget, std::string a_fbeam_en, std::string a_file_name, TTree *tree) : fChain(0)
{
    fbeam_en = a_fbeam_en;
    ftarget = a_ftarget; 
    ffile_name = a_file_name;
    const char *inputFile = ffile_name.c_str();
...
Int_t event_selector::GetEntry(Long64_t entry)
{
...
Long64_t event_selector::LoadTree(Long64_t entry)
{
...
void event_selector::Init(TTree *tree)
{
...
void event_selector::Show(Long64_t entry)
{
...
Int_t event_selector::Cut(Long64_t entry)
{
